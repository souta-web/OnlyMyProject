...
class TimeLineActionsData {
  late List<Map<String, dynamic>> newData = [{"startTime": "0:00","endTime": "1:45" ,"color": Colors.amber,"title": "ポケモンスリープしない"},
                                              ...
                                              {"startTime": "19:00","endTime": "20:30" ,"color": Colors.white,"title": "newDataです"},
                                              ];
}